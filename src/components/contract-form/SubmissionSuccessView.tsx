  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#EBE3D5] rounded-3xl p-7 sm:p-10 text-center shadow-sm max-w-lg mx-auto space-y-6 animate-fade-in my-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs sm:text-sm text-[#6E5C3D] leading-relaxed max-w-md mx-auto pt-1 break-keep">
          대표가 작성해 주신 내용을 확인한 후, 입력하신 이메일(<strong className="text-[#322A1B]">{email}</strong>)로 공식 계약서를 <span className="whitespace-nowrap">신속하게 발송해 드립니다.</span>
        </p>
      </div>
      ...
      <div className="bg-[#FAF8F5] border border-[#EBE3D5] rounded-2xl p-4 text-xs text-[#8F7A56] text-left space-y-2">
        ...
        <p className="text-[11px] text-[#A8987E] pl-6 break-keep leading-relaxed">
      ...
      <div className="pt-2 space-y-2">
        ...
        {closedNotice && (
          <p className="text-xs text-[#8F7A56] animate-fade-in pt-1 break-keep leading-relaxed">
