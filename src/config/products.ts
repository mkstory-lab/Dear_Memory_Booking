...
export const PRODUCTS_CONFIG: ProductItem[] = [
  ...
  },
  {
    ...
    includedItems: [
      ...
      '신부대기실 ~ 본식 ~ 원판 ~ 연회장',
      '1인 작가 촬영 (대표/수석 작가)',
      '웹용 고화질 원본 (+500장, 총 2,500장 이상 전체 제공)',
      '정밀 세부 보정본 80장 (실속형 대비 +10장)',
      '부부앨범 15x12 80p 1권 (+10p 증면)',
      '부모님앨범 12x8 40p 2권 추가 제공'
    ],
    ...
    plusBenefits: [
      {
        title: '양가 부모님 앨범 2권 추가 증정',
        detail: '부모님앨범 12x8 40p 2권 (원판+스냅 합본, 양가 부모님 선물용)',
        badge: '2권 증정',
      },
      {
        title: '화보형 부부앨범 10p 증면 업그레이드',
        detail: '70p → 80p 1권 (15x12 대형 프리미엄 화보 앨범)',
        badge: '+10p 증면',
      },
      {
        title: '정밀 세부 보정본 10장 확대',
        detail: '70장 → 총 80장 정밀 세부 보정본 제공',
        badge: '+10장 추가',
      },
      {
        title: '웹용 고화질 원본 (+500장)',
        detail: '실속형 2,000장 대비 +500장 확대된 총 2,500장 이상 제공',
        badge: '+500장 증정',
      },
    ],
  },
